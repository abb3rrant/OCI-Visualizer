...
export default React.memo(function InstanceSummaryNode({ data }: NodeProps) {
  ...
  if (d?.compact) {
    return (
      <div className="bg-blue-50 dark:bg-blue-950 border border-blue-300 dark:border-blue-700 border-dashed rounded-lg px-2 py-1 flex items-center gap-1.5">
        <span className="w-4 h-4 rounded bg-blue-400 text-white text-[8px] flex items-center justify-center font-bold shrink-0">VM</span>
        <span className="text-[10px] font-medium text-blue-800 dark:text-blue-200">{count} VMs</span>
