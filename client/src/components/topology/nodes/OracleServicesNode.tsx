...
export default React.memo(function OracleServicesNode({ data }: NodeProps) {
  ...
  if (d?.compact) {
    return (
      <div className="bg-orange-50 dark:bg-orange-950 border border-orange-400 dark:border-orange-700 rounded-lg px-2 py-1 flex items-center gap-1.5">
        <span className="w-4 h-4 rounded-full bg-orange-500 text-white text-[7px] flex items-center justify-center font-bold shrink-0">OSN</span>
        <span className="text-[10px] font-medium text-orange-700 dark:text-orange-300">Oracle Svc</span>
