...
import AuditRulesManager from '../components/audit/AuditRulesManager';
...
export default function AuditPage() {
  ...
  type TabType = 'findings' | 'tags' | 'rules';
  const activeTab = (searchParams.get('tab') as TabType) || 'findings';
        ...
        <div className="flex items-center gap-2">
          {report && (
            <>
              ...
              <DownloadPdfButton report={report} snapshotName={currentSnapshot.name} />
        ...
        <>
          ...
          <div className="flex gap-2 border-b border-gray-200 dark:border-gray-700 no-print">
            ...
            <button
              ...
              className={`px-4 py-2 text-sm font-medium border-b-2 ${activeTab === 'rules' ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-500 dark:text-gray-400'}`}
            >
              Custom Rules
            </button>
          </div>
