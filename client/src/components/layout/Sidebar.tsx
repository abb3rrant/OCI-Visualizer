...
function CompartmentTreeItem({ node, depth }: { node: CompartmentNode; depth: number }) {
  ...
  return (
    <div>
      ...
      >
        {hasChildren ? (
          <button onClick={() => setExpanded(!expanded)} className="w-4 h-4 flex items-center justify-center text-gray-400 dark:text-gray-500 shrink-0">
        ...
        <span
          className="truncate text-gray-700 dark:text-gray-200 group-hover:text-blue-600"
