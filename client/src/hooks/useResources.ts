...
export function useResources(filter: { snapshotId: string; resourceType?: string; compartmentId?: string; lifecycleState?: string; search?: string; isRegex?: boolean; first?: number; after?: string; skip?: number }) {
