...
export default function DatabaseNode({ data }: NodeProps) {
  const d = data as any;
  return (
    <div className="bg-white border-2 border-pink-400 rounded-lg p-2.5 min-w-[140px] shadow-sm">
      <div className="flex items-center gap-2">
        ...
        <div className="min-w-0">
          <div className="text-xs font-semibold truncate">{d?.label || 'Database'}</div>
